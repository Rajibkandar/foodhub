...
import photo1 from '../components/photo-1549611016-3a70d82b5040.jpg';
import photo2 from '../components/photo-1605478371310-a9f1e96b4ff4.jpg';
export default function Home() {
  ...
  const filteredCategories = foodCat.filter((cat) =>
    foodItem.some((item) =>
      item.CategoryName === cat.CategoryName && item.name.toLowerCase().includes(search.toLowerCase())
    )
  );
      ...
      <div>
        <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel" style={{ objectFit: "contain !important" }}>
          <div className="carousel-inner" id='carousel'>
            ...
            <div className="carousel-item">
              <img src="https://source.unsplash.com/random/900×700/?rice" className="d-block w-100" alt="..." />
            </div>
          </div>
